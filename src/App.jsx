				...
				<BrowserRouter>
					<Routes>
						...
						>
							...
							<Route
								path={ROUTE_PATH.BOOKINGS_BOOKING_ID}
								element={<Booking />}
							/>
							<Route
								path={ROUTE_PATH.CHECKIN_BOOKING_ID}
								element={<Checkin />}
							/>
							<Route path={ROUTE_PATH.CABINS} element={<Cabins />} />
							<Route path={ROUTE_PATH.USERS} element={<Users />} />
							<Route path={ROUTE_PATH.SETTINGS} element={<Settings />} />
							<Route path={ROUTE_PATH.ACCOUNT} element={<Account />} />
						</Route>
